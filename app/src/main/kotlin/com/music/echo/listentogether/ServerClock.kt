 ...
 * would make [positionAt] jump. On Android the injected source is `SystemClock.elapsedRealtime`,
 * which also counts deep sleep (unlike `System.currentTimeMillis`, which is what made the previous
 * implementation of this feature seek wrongly after the screen had been off).
 */
