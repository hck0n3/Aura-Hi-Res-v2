...
// already exists on fresh installs; users who chose their own preamp (anything != 0.0) keep it.
val EqPreampDefault3DbAppliedKey = booleanPreferencesKey("eq_preamp_default_3db_applied")
// One-time (FRESH key, owner request 2026-08-26): lower the EQ preamp default from +3.0 to +2.0 dB —
