...
- **No improvisa.** Para una época o un momento no coge "la primera lista que salga": junto a "Éxitos de los 80" el buscador devuelve también listas de gente ("mi mix", "para el carro") con cualquier cosa dentro. Ahora mira seis candidatas —primero las editoriales de YouTube Music— y solo acepta una si su **título demuestra** que corresponde: si pediste una década, tiene que nombrarla. Si ninguna lo demuestra, no usa ninguna y busca canciones. Los vídeos (recopilaciones de una hora, versiones de aficionado) pasan a ser el último recurso absoluto.
