...
data class AlbumPage(
    ...
    val descriptionRuns: List<com.music.innertube.models.Run>? = null,
) {
    companion object {
        ...
        fun getSong(renderer: MusicResponsiveListItemRenderer, album: AlbumItem? = null): SongItem? {
            ...
            return SongItem(
                ...
                album = album?.let {
                    ...
                    Album(
                        name = it.text,
                        // Remote JSON may omit the browseId; skip building the album rather than crash the whole
                        // mapNotNull (one malformed row used to fail the entire album parse).
                ...
                thumbnail = renderer.thumbnailUrlOrFallback ?: album?.thumbnail ?: return null,
